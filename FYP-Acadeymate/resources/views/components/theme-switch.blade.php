...
<div x-data="window.themeSwitcher()" x-init="switchTheme()" @keydown.window.tab="switchOn = false" class="flex items-center justify-center space-x-2">
	<input id="thisId" type="checkbox" name="switch" class="hidden" :checked="switchOn">
		...
		:class="switchOn ? 'bg-sky-900' : 'bg-orange-400'"
		class="theme-button-complete relative inline-flex py-0.5 ml-4 focus:outline-none rounded-full w-16">
		<span :class="switchOn ? 'translate-x-[36px]' : 'translate-x-[4px]'" class="theme-button-toggle hover:bg-slate-200 duration-200 ease-in-out bg-white rounded-full shadow-md"></span>
	</button>
</div>
